...
import { getBreakfastCart} from "../../../../api/shops/shopManage";

class SelectBreakfastGroup extends Component {
	constructor(props) {
		super(props);
		this.state = {
			selectedItems:[],
	...
	componentDidMount() {
		getBreakfastCart({limit:10,page:1}).then(r=>{
	...
	getUserList = (page) =>{
		getBreakfastCart({limit:10,page}).then(r=>{
...
export default SelectBreakfastGroup;
