...
class EChartsLeft extends Component {
	...
	render() {
		const yAxis = [
			{name: '店铺数量',key:'shop_count'},
			{name: '客户数量',key:'user_count'},
			{name: '订单总数',key:'order_count'},
			{name: '订货单数量',key:'shop_order_count'},
			{name: '消费者预订单数量',key:'pick_order_count'},
		];
		const range = [
			{name: '日', key: 'day'},
			{name: '周', key: 'week'},
