	...
	constructor(props){
		const columns = [
			...
			},
			{
				...
				render: (text,record) =>{
					if (window.hasPermission("product_distribution_mall_book_set_virtual_sale")) {
						return <InputNumber
			...
			},
			{
				...
				render: (text,record) =>
					<div>
						{
							window.hasPermission("product_distribution_mall_book_set_sale_scope") && <span
								style={{'color':'#4F9863','cursor':'pointer'}}
						...
						{
							window.hasPermission("product_distribution_mall_book_set_stock_alert") && <span
		...
		this.channel = 'DISTRIBUTION_MALL';
		this.state = {
			api:channelsGoods,
		...
		return (
			<div>
				...
				<div className="breakfast_header">
					{
						window.hasPermission("product_distribution_mall_book_put_on") && <Button type="primary" size="small" onClick={this.showShelfGoods}>上架商品</Button>
					}
					{
						window.hasPermission("product_distribution_mall_book_add_stock") && <Button size="small" onClick={this.inStock}>
							<IconFont type="icon-download" />
							商品入库
						</Button>
					}
					{
						window.hasPermission("product_distribution_mall_book_out_stock") && <Button size="small" onClick={this.outStock}>
				...
				<div className="s_body">
					<div className="headerLeft">
						...
						{
							window.hasPermission("product_distribution_mall_book_get_off") && <Button
								size="small"
